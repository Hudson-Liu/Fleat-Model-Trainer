...
with open("/kaggle/input/hypt-keras-tuner-optimizer-dataset/datasets_optimization", "rb") as fp:
...
#SubSets
RUN = 0 #Has to be either 0, 1, 2, or 3; 0 runs for 4 hours, 1 & 2 runs for 10 hours, 3 runs for 4 hours
if RUN == 0: #18
